 ...
 */
public class UpdateProfile extends Fragment implements ConnectionReceiver.ConnectionReceiverListener {
    ...
    @BindView(R.id.fnamerow) RelativeLayout fnameRow;
    ...
    String sCompanyName, Sfname, sLaname, sState, sCity, sCountry, sPhone, sAddress, sheadline, sSummary;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(type == 2){
            ...
            if(company.getCountry() != null){
                country.setSelection(getIndex(country, new CountryCodes().getCode(company.getCountry())));
            }
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(type == 1){
                    ...
                    if(vaildate(city,address,lastName,firstName,phone,state,headline,summary)){
                        new Thread(new Runnable() {
                            @Override
                            public void run() {
                                try {
                                    Response response = serverConnections.UserUpdate(Sfname,sLaname,industry.getSelectedItemPosition() + 1, getCountries2Letters(sCountry),sCity,sAddress,sPhone,sheadline,sSummary,"12/12/1991",getActivity());
                                    if(response.code() == 200 || response.code() == 201){
                                        getActivity().runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
